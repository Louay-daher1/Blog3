...
@section('content')
    ...
    <div class="container m-auto pt-10 pb-5">
       <form action="/blog" method="POST" enctype="multipart/form-data">
        @csrf
        <input type="text" name="title" placeholder="Title"  class="w-full h-10 text-6xl rounded-lg shadow-lg border-b p-4 mb-2"/>
        <textarea name="description" placeholder="Description"  class="w-full h-10 text-6xl rounded-lg shadow-lg border-b p-10 mt-5"></textarea>
